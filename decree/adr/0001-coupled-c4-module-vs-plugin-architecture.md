...
PRD-001 requires decree to validate C4 architecture metadata on SPECs. The question is how to integrate this: as a tightly coupled module in decree's core, or as a pluggable extension system that could support C4 and future metadata schemes.
