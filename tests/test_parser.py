...
class TestADRDocument:
    ...
    def test_missing_sections(self, project_dir, monkeypatch):
        ...
        body = "# T\n\n## Context and Problem Statement\n\nText.\n"
        missing = self._make_doc(body=body).missing_sections
...
class TestFileIO:
    def test_roundtrip(self, tmp_path):
        ...
        doc.meta = ADRFrontmatter(status="accepted", date=doc.meta.date)
        save(doc)
